...
export default function CameraCRUD() {
  ...
  return (
    <div className="space-y-5">
      {/* HEADER */}
      <div>
        <h1 className="text-2xl font-bold text-white">Readers</h1>
        <p className="text-slate-400 text-2xl mt-1">Manage system Readers</p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-[#0f172a] border border-white/10 rounded-2xl p-4">
          <p className="text-slate-400 text-2xl">Total Devices</p>
          <h2 className="text-2xl font-bold text-white mt-2">{totalDevices}</h2>
        </div>
        ...
        <div className="bg-[#0f172a] border border-white/10 rounded-2xl p-4">
          <p className="text-slate-400 text-2xl">Total QR Readers</p>
